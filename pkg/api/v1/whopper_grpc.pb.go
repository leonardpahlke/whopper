...
type HubClient interface {
	RunHub(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *hubClient) RunHub(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/whopper.api.v1.Hub/RunHub", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HubServer interface {
	RunHub(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedHubServer) RunHub(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _Hub_RunHub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/whopper.api.v1.Hub/RunHub",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServer).RunHub(ctx, req.(*emptypb.Empty))
	}
...
var Hub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "whopper.api.v1.Hub",
